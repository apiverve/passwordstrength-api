...
namespace APIVerve.API.PasswordStrength
{
    ...
    /// <summary>
    /// Client for the PasswordStrength API
    /// </summary>
    public class PasswordStrengthAPIClient
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        : IDisposable
#endif
    {
        private readonly string _apiEndpoint = "https://api.apiverve.com/v1/passwordstrength";
        ...
        {
            { "password", new ValidationRule { Type = "string", Required = true } }
        };
        ...
        public PasswordStrengthAPIClient(string apiKey)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public PasswordStrengthAPIClient(string apiKey, bool isSecure, bool isDebug)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public PasswordStrengthAPIClient(string apiKey, bool isSecure, bool isDebug, HttpClient httpClient)
        {
        ...
        public void ExecuteAsync(ExecuteAsyncCallback callback, PasswordStrengthQueryOptions options = null)
        {
            if (callback == null)
            {
        ...
        private void ValidateParams(PasswordStrengthQueryOptions options)
        {
        ...
        public ResponseObj Execute(PasswordStrengthQueryOptions options = null)
        {
        ...
        public Task<ResponseObj> ExecuteAsync(PasswordStrengthQueryOptions options = null)
        {
        ...
        public async Task<ResponseObj> ExecuteAsync(PasswordStrengthQueryOptions options, CancellationToken cancellationToken)
        {
            int attempt = 0;
        ...
        /// </summary>
        private async Task<ResponseObj> ExecuteRequestAsync(PasswordStrengthQueryOptions options, CancellationToken cancellationToken)
        {
            try
            {
        ...
        /// </summary>
        private ResponseObj ExecuteWithWebRequest(PasswordStrengthQueryOptions options)
        {
            int attempt = 0;
            Exception lastException = null;
        ...
        /// </summary>
        private ResponseObj ExecuteWebRequestInternal(PasswordStrengthQueryOptions options)
        {
            try
            {
                Log("Executing API request...");
        ...
        /// </summary>
        private string ConstructURL(PasswordStrengthQueryOptions options)
        {
