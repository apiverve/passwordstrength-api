...
```gradle
dependencies {
    implementation 'com.github.apiverve:passwordstrength-api:1.1.13'
}
```
...
```java
import com.apiverve.passwordstrength.PasswordStrengthAPIClient;
import com.apiverve.passwordstrength.APIResponse;
import com.apiverve.passwordstrength.APIException;

// Initialize the client
PasswordStrengthAPIClient client = new PasswordStrengthAPIClient("YOUR_API_KEY");
...
For detailed API documentation, visit: [https://docs.apiverve.com/ref/passwordstrength](https://docs.apiverve.com/ref/passwordstrength)
...
- **Documentation:** [https://docs.apiverve.com/ref/passwordstrength](https://docs.apiverve.com/ref/passwordstrength)
- **Issues:** [GitHub Issues](https://github.com/apiverve/passwordstrength-api/issues)
