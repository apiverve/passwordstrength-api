// Package passwordstrength provides a Go client for the Password Strength API.
//
// For more information, visit: https://apiverve.com/marketplace/passwordstrength?utm_source=go&utm_medium=readme
...
// Request contains the parameters for the Password Strength API.
//
// Parameters:
//   - password (required): string - The password to check the strength of
type Request struct {
...
// ResponseData contains the data returned by the Password Strength API.
type ResponseData struct {
	Strength string `json:"strength"`
	PasswordInfo PasswordInfoData `json:"passwordInfo"`
}

// PasswordInfoData represents the passwordInfo object.
type PasswordInfoData struct {
	Length int `json:"length"`
	HasSpecialCharacters bool `json:"hasSpecialCharacters"`
