...
const (
	baseURL        = "https://api.apiverve.com/v1/passwordstrength"
	defaultTimeout = 30 * time.Second
)

// Client is the Password Strength API client.
type Client struct {
	apiKey     string
	httpClient *resty.Client
}

// NewClient creates a new Password Strength API client.
...
// Execute makes a request to the Password Strength API with typed parameters.
//
